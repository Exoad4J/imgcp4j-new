    ...
    Thread worker = new Thread(() -> {
      while (true) {
        ...
        if (isVisible() && isShowing()) {
          if (java.awt.MouseInfo.getPointerInfo().getLocation().x > getLocationOnScreen().x
                  && java.awt.MouseInfo.getPointerInfo().getLocation().x < getLocationOnScreen().x + getWidth()
                  && java.awt.MouseInfo.getPointerInfo().getLocation().y > getLocationOnScreen().y
                  && java.awt.MouseInfo.getPointerInfo().getLocation().y < getLocationOnScreen().y + getHeight()) {
            cc.updatePosition(java.awt.MouseInfo.getPointerInfo().getLocation().x, java.awt.MouseInfo.getPointerInfo().getLocation().y);
